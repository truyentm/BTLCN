...
$(document).ready(function(){
     $(".owl-carousel").owlCarousel({
         items: 3, // Số lượng phần tử hiển thị trên mỗi slide
         autoplay: true, // Tự động chạy slide
         loop: true, // Lặp lại carousel
         margin: 20 // Khoảng cách giữa các slide
      });
   });
gsap.to(".my-element", { x: 100, duration: 2, ease: "power1.out" });

// JavaScript code using jQuery Datepicker
$(function() {
  ...
  $(document).ready(function () {
    // Initialize Colorbox
    $(".colorbox").colorbox({
        rel: 'gallery', // This groups images into a gallery
        maxWidth: '95%',
        maxHeight: '95%'
    });
});
